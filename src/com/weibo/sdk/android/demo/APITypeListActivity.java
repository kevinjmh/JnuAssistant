...
//		startActivity(it);
		...
		if("发送微博".equals(title)){
            ...
            StatusesAPI statusApi=new StatusesAPI(WeiboActivity.accessToken);
            ...
            ActivityInvokeAPI.openUserInfoByUid(this,"232510445");
        }
        else if("打开用户信息页面 nickname".equals(title)){
            ActivityInvokeAPI.openUserInfoByNickName(this, "劉橋偉");
        }
