...
public class BlogFunActivity extends Activity implements OnClickListener{
    ...
    public void onClick(View v) {
        if(v.equals(btnFav)){
            ...
            FavoritesAPI  fav=new FavoritesAPI(WeiboActivity.accessToken);
...
//                    Util.showToast(BlogFunActivity.this,response);
            ...
            Util.showToast(BlogFunActivity.this,"api访问请求已执行，请等待结果");
                    StatusesAPI  status=new StatusesAPI(WeiboActivity.accessToken);
...
//                            Util.showToast(BlogFunActivity.this,response);
            ...
            Util.showToast(BlogFunActivity.this,"api访问请求已执行，请等待结果");
            CommentsAPI  comment=new CommentsAPI(WeiboActivity.accessToken);
